        ...
        return response()->json([
            ...
            'data' => $shortUrls->map(function ($url) {
                return [
                    ...
                    'short_url' => config('app.frontend_url') . $url->short_code,
                    'clicks' => $url->clicks,
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if ($existingUrl && !$existingUrl->isExpired()) {
            return response()->json([
                ...
                'data' => [
                    ...
                    'short_url' => config('app.frontend_url') . $existingUrl->short_code,
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'short_url' => config('app.frontend_url') . $shortUrl->short_code,
